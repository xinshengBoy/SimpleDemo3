 ...
 * https://github.com/rvganesh212/ruler/blob/master/Ruler/app/src/main/res/values/attrs.xml
 */
public class RulerView extends View {
    ...
    public RulerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        backgroundColor = a.getColor(R.styleable.RulerView_rulerbackgroundColor, 0xFFFACC31);
