...
public class Chessboard extends View {
    ...
    private final int mRow = 8;//棋盘是一个八行八列的样式
    private final int mCol = 8;
    private final int mBorderLineWidth = 8;//边线宽度
    private final int mNormalLineWidth = 3;//普通线宽度（棋盘里面的线的宽度）
    ...
    private int mWidth;
    private int mHeight;
    private float mGridW;//每个格子的长度
    private float mGridH;//每个格子的高度
